  ...
  const projects: Project[] = [
    {
      ...
      previewImage: "/assets/projects/blackfriday.png",
      order: 1,
    ...
    },
    {
      ...
      previewImage: "/assets/projects/bobby.png",
      order: 2,
      createdAt: new Date().toISOString(),
    },
    {
  ...
  const experiences: Experience[] = [
    {
      ...
      logo: "/assets/enterprises/SAP.png",
      order: 1,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      logo: "/assets/enterprises/IZHO.jpg",
      order: 2,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      logo: "/assets/enterprises/SIMPLOS.jpg",
      order: 3,
      createdAt: new Date().toISOString(),
    },
  ];
  ...
  const schools: School[] = [
    {
      ...
      tags: [],
      logo: "/assets/certifications/UTC.png",
      order: 1,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      to: { en: "2024", fr: "2024" },
      tags: [],
      logo: "/assets/certifications/IUT.jpg",
      order: 2,
      createdAt: new Date().toISOString(),
    },
    {
